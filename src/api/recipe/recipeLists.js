...
export const getRecipeListsForUser = (
  ...
  timeoutPromise(
    ...
    .catch(err => {
      throw 'Something unexpected happened getting recipe lists for user';
    });
...
export const getUsersForRecipeList = (
  token: string,
  recipeListId: string,
): Promise<*> =>
  timeoutPromise(
    NETWORK_TIMEOUT,
    'Request timed out',
    fetch(`${recipeListsUrl}/${recipeListId}/users`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: token,
...
export const removeUserFromRecipeList = (
  token: string,
  user: User,
  recipeList: RecipeList,
): Promise<*> =>
  timeoutPromise(
    NETWORK_TIMEOUT,
    'Request timed out',
    fetch(`${recipeListsUrl}/${recipeList.id}/users/${user.id}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: token,
...
export const addUserToRecipeList = (
  token: string,
  user: User,
  recipeList: RecipeList,
): Promise<*> =>
